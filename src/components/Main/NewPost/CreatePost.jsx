    ...
    return (
        ...
        <form className={classes["create-post"]}>
            ...
            <div className={classes["form-control"]}>
                <textarea className={classes.input} role="textbox" contentEditable placeholder="What's on your mind, Uy Dũng?" />
                <button>Emoji</button>
            </div>
            ...
            <button>Post</button>
            <span className={classes.error}>This post appears to be blank. Please write something or attach a link or photo to post.</span>
        </form>
        </Modal>
    );
};
